...
const DevelopmentSlabs = () => {
  ...
  // Fetch statistics for development slabs only
  const { data: stats } = useQuery({
    queryKey: ['development-slab-stats'],
    queryFn: async () => {
      console.log('Fetching development slab statistics...');
      ...
      try {
        ...
        console.error('Error in development slabs stats query:', error);
        throw error;
      }
    },
    retry: 3,
...
export default DevelopmentSlabs;